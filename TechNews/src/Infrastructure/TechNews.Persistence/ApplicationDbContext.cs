...
namespace TechNews.Persistence
{
    ...
    public class ApplicationDbContext:DbContext
    {
        ...
        public DbSet<LiveInterview> LiveInterviews { get; set; }
        public DbSet<Magazine> Magzines { get; set; }
        ...
        public DbSet<WebinarHolder> WebinarHolders { get; set; }
        ...
        public DbSet<DynamicFormData> DynamicFormDatas { get; set; }
        public DbSet<DynamicFormMultipleOption> DynamicFormMultipleOptions { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Article>()
                .HasIndex(x => x.ArticleCategoryId)
                .IsUnique(false);
            modelBuilder.Entity<Article>()
               .HasIndex(x => x.ArticleSubCategoryId)
               .IsUnique(false);
