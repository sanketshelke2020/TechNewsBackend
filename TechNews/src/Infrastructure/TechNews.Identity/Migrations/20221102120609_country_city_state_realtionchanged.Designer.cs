...
namespace TechNews.Identity.Migrations
{
    ...
    [Migration("20221102120609_country_city_state_realtionchanged")]
    partial class country_city_state_realtionchanged
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "36202aa5-d079-429a-9d90-15c9bd87f7ac",
                            ConcurrencyStamp = "a9a963d4-66e0-4a09-b3fb-d97628d0d7ed",
                            Name = "Viewer",
                            NormalizedName = "VIEWER"
                        },
                        new
                        {
                            Id = "28dc3923-39ca-4f1a-a630-667aa9183e04",
                            ConcurrencyStamp = "1b066a9f-84be-4377-a235-af271a865fc6",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("TechNews.Identity.Models.ApplicationUser", b =>
                {
                    b.HasOne("TechNews.Identity.Models.City", "City")
                        .WithOne()
                        .HasForeignKey("TechNews.Identity.Models.ApplicationUser", "CityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TechNews.Domain.Entities.Country", "Country")
                        .WithOne()
                        .HasForeignKey("TechNews.Identity.Models.ApplicationUser", "CountryId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TechNews.Identity.Models.State", "State")
                        .WithOne()
                        .HasForeignKey("TechNews.Identity.Models.ApplicationUser", "StateId")
                        .OnDelete(DeleteBehavior.Restrict);
